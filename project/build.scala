...
object build extends Build {
  lazy val sharedSettings = Defaults.defaultSettings ++ Seq(
    ...
    description := "Macro-expansion at Runtime for Scala in Project Palladium",
  ...
  lazy val publishableSettings = sharedSettings ++ Seq(
    ...
    pomExtra := (
      <url>https://github.com/scalareflect/mars</url>
      ...
      <scm>
        <url>git://github.com/scalareflect/mars.git</url>
        <connection>scm:git:git://github.com/scalareflect/mars.git</connection>
      </scm>
      <issueManagement>
        <system>GitHub</system>
        <url>https://github.com/scalareflect/mars/issues</url>
      </issueManagement>
    ),
